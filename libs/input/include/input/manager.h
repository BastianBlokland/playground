...
typedef enum eInputBlocker {
  InputBlocker_Debug            = 1 << 0,
  InputBlocker_TextInput        = 1 << 1,
  InputBlocker_HoveringUi       = 1 << 2,
  InputBlocker_CursorLocked     = 1 << 3, // Managed by the input library.
  InputBlocker_CursorConfined   = 1 << 4, // Managed by the input library.
  InputBlocker_WindowFullscreen = 1 << 5, // Managed by the input library.
} InputBlocker;
