...
static const String g_devGraphics[DevShapeType_Count] = {
    shape_graphic(BoxFill,                    "graphics/builtin/dev/shape_box_fill.graphic"),
    shape_graphic(BoxWire,                    "graphics/builtin/dev/shape_box_wire.graphic"),
    shape_graphic(BoxOverlay,                 "graphics/builtin/dev/shape_box_overlay.graphic"),
    shape_graphic(QuadFill,                   "graphics/builtin/dev/shape_quad_fill.graphic"),
    shape_graphic(QuadWire,                   "graphics/builtin/dev/shape_quad_wire.graphic"),
    shape_graphic(QuadOverlay,                "graphics/builtin/dev/shape_quad_overlay.graphic"),
    shape_graphic(SphereFill,                 "graphics/builtin/dev/shape_sphere_fill.graphic"),
    shape_graphic(SphereWire,                 "graphics/builtin/dev/shape_sphere_wire.graphic"),
    shape_graphic(SphereOverlay,              "graphics/builtin/dev/shape_sphere_overlay.graphic"),
    shape_graphic(HemisphereUncappedFill,     "graphics/builtin/dev/shape_hemisphere_uncapped_fill.graphic"),
    shape_graphic(HemisphereUncappedWire,     "graphics/builtin/dev/shape_hemisphere_uncapped_wire.graphic"),
    shape_graphic(HemisphereUncappedOverlay,  "graphics/builtin/dev/shape_hemisphere_uncapped_overlay.graphic"),
    shape_graphic(CylinderFill,               "graphics/builtin/dev/shape_cylinder_fill.graphic"),
    shape_graphic(CylinderWire,               "graphics/builtin/dev/shape_cylinder_wire.graphic"),
    shape_graphic(CylinderOverlay,            "graphics/builtin/dev/shape_cylinder_overlay.graphic"),
    shape_graphic(CylinderUncappedFill,       "graphics/builtin/dev/shape_cylinder_uncapped_fill.graphic"),
    shape_graphic(CylinderUncappedWire,       "graphics/builtin/dev/shape_cylinder_uncapped_wire.graphic"),
    shape_graphic(CylinderUncappedOverlay,    "graphics/builtin/dev/shape_cylinder_uncapped_overlay.graphic"),
    shape_graphic(ConeFill,                   "graphics/builtin/dev/shape_cone_fill.graphic"),
    shape_graphic(ConeWire,                   "graphics/builtin/dev/shape_cone_wire.graphic"),
    shape_graphic(ConeOverlay,                "graphics/builtin/dev/shape_cone_overlay.graphic"),
    shape_graphic(LineOverlay,                "graphics/builtin/dev/shape_line_overlay.graphic"),
};
  ...
  for (EcsIterator* itr = ecs_view_itr(ecs_world_view_t(world, ShapeView)); ecs_view_walk(itr);) {
    ...
    dynarray_for_t(&shape->entries, DevShape, entry) {
      ...
      case DevShapeType_BoxOverlay: {
        ...
        const RendTags tags = RendTags_Debug;
        const GeoBox   bounds =
