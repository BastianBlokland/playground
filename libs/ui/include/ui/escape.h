...
/**
 * Create a formatting argument that contains a background escape sequence.
 * NOTE: Resulting string is allocated in scratch memory, should NOT be stored.
 */
#define fmt_ui_background(_COLOR_) fmt_text(ui_escape_background_scratch(_COLOR_))
...
String ui_escape_background_scratch(UiColor);
