...
static const RendResGlobalDef g_rendResGlobal[] = {
  { .repoId = RvkRepositoryId_AmbientDebugGraphic,          .assetId = string_static("graphics/builtin/ambient_debug.graphic") },
  { .repoId = RvkRepositoryId_AmbientGraphic,               .assetId = string_static("graphics/builtin/ambient.graphic") },
  { .repoId = RvkRepositoryId_AmbientOcclusionGraphic,      .assetId = string_static("graphics/builtin/ambient_occlusion.graphic") },
  { .repoId = RvkRepositoryId_DebugImageViewerArrayGraphic, .assetId = string_static("graphics/builtin/dev/image_viewer_array.graphic") },
  { .repoId = RvkRepositoryId_DebugImageViewerCubeGraphic,  .assetId = string_static("graphics/builtin/dev/image_viewer_cube.graphic") },
  { .repoId = RvkRepositoryId_DebugImageViewerGraphic,      .assetId = string_static("graphics/builtin/dev/image_viewer.graphic") },
  { .repoId = RvkRepositoryId_DebugMeshViewerGraphic,       .assetId = string_static("graphics/builtin/dev/mesh_viewer.graphic") },
...
bool rend_res_texture_is_array(const RendResTextureComp* comp) {
  return comp->texture->image.type == RvkImageType_ColorSourceArray;
}
