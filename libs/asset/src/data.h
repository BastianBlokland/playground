...
void asset_data_init_import_mesh(bool devSupport);
void asset_data_init_import_texture(bool devSupport);
...
extern DataType g_assetFormatType;
...
u32  asset_data_query_refs_unpatched(
     EcsWorld*, AssetManagerComp*, DataMeta, Mem data, EcsEntityId out[], u32 outMax);
