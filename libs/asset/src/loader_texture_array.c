 ...
 */
ecs_system_define(AssetArrayTexLoadAcquireSys) {
 ...
 */
ecs_system_define(AssetArrayTexLoadUpdateSys) {
  EcsView*     loadView   = ecs_world_view_t(world, LoadView);
...
ecs_module_init(asset_texture_array_module) {
  ...
  ecs_register_system(AssetArrayTexLoadAcquireSys, ecs_view_id(ManagerView), ecs_view_id(LoadView));
  ecs_register_system(AssetArrayTexLoadUpdateSys, ecs_view_id(LoadView), ecs_view_id(TextureView));
}
