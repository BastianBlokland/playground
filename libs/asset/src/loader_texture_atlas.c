 ...
 */
ecs_system_define(AssetAtlasLoadSys) {
 ...
 */
ecs_system_define(AssetAtlasUnloadSys) {
...
ecs_module_init(asset_texture_atlas_module) {
  ...
  ecs_register_system(
      AssetAtlasLoadSys, ecs_view_id(ManagerView), ecs_view_id(LoadView), ecs_view_id(TextureView));

  ecs_register_system(AssetAtlasUnloadSys, ecs_view_id(AtlasUnloadView));
}
