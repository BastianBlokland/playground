 ...
 */
ecs_system_define(AssetFontTexLoadSys) {
 ...
 */
ecs_system_define(AssetFontTexUnloadSys) {
...
ecs_module_init(asset_texture_font_module) {
  ...
  ecs_register_system(
      AssetFontTexLoadSys, ecs_view_id(ManagerView), ecs_view_id(LoadView), ecs_view_id(FontView));

  ecs_register_system(AssetFontTexUnloadSys, ecs_view_id(FontTexUnloadView));
}
