 ...
 * Load icon assets.
 */
ecs_system_define(AssetIconInitSys) {
 ...
 */
ecs_system_define(AssetIconUnloadSys) {
...
ecs_module_init(asset_icon_module) {
  ...
  ecs_register_system(
      AssetIconInitSys, ecs_view_id(ManagerView), ecs_view_id(LoadView), ecs_view_id(TextureView));
  ecs_register_system(AssetIconUnloadSys, ecs_view_id(UnloadView));
}
