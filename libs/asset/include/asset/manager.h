...
/**
 * Register additional memory records that can be loaded with the '{id}:{record-id}' syntax.
 */
bool asset_manager_add_mem(
    AssetManagerComp*, String id, const AssetMemRecord* records, usize recordCount);
