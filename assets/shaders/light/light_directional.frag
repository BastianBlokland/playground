...
bind_spec(0) const f32 s_coverageScale     = 50;
bind_spec(1) const f32 s_coveragePanSpeedX = 0.35;
bind_spec(2) const f32 s_coveragePanSpeedY = 0.1;
...
bind_global_img(6) uniform sampler2DShadow u_texShadow;
...
void main() {
  ...
  if (tag_is_set(geoBase.tags, tag_unlit_bit)) {
    out_color = f32v3(0);
    return;
  }
